...
export default function Header() {
  ...
  return (
    <>
      <div className="bg-white/10 backdrop-blur-md border-gray-200 dark:bg-black/20 dark:border-white/10 border-b py-2 px-4 md:px-0 fixed w-full shadow-xs z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Button className="group relative">
              ...
              {/*<div className="w-1 h-1 bg-red-500 rounded-full absolute bottom-0 left-0 right-0 mx-auto"></div>*/}
            </Button>
